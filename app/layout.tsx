...
const OnboardingFlow = dynamic(
  () =>
    import("@/components/onboarding/OnboardingFlow").then((mod) => ({
...
export const metadata: Metadata = {
  ...
  description:
    "Discover all apprenticeships in one place. Find opportunities, optimise your CV with AI, and access more features to help you land your first apprenticeship.",
  keywords:
    "apprenticeships, UK apprenticeships, apprenticeship search, career opportunities, job training, vocational training, apprentice jobs, apprenticeship programs",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://cdn.apprenticewatch.com/meta/apprentice-watch.png",
        width: 1200,
        height: 630,
        alt: "ApprenticeWatch",
      },
  ...
  twitter: {
    ...
    description:
      "Discover all apprenticeships in one place. Find opportunities, optimise your CV with AI, and access more features to help you land your first apprenticeship.",
    images: ["https://cdn.apprenticewatch.com/meta/apprentice-watch.png"],
    creator: "@apprenticewatch",
