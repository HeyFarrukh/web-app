...
export const CVGuide = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <Helmet>
        <title>CV Writing Guide | ApprenticeWatch</title>
        <meta name="description" content="Master CV writing with our comprehensive guide. Learn how to create impactful CVs for apprenticeships and early careers." />
        <meta name="keywords" content="CV writing, resume guide, apprenticeship CV, career development, CV optimisation" />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg mb-12">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-blue-500 flex-shrink-0" size={20} />
              <span className="text-orange-600 dark:text-green-400">What you did & how (skills/job description) → Measurable impact (quantified).</span>
            </li>
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-blue-500 flex-shrink-0" size={20} />
        ...
        <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg mb-12">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-orange-500 flex-shrink-0" size={20} />
              <span className="text-gray-700 dark:text-gray-300">
                If it’s hard to quantify your work, use “Action” & “Result” from the <a href = "https://uk.indeed.com/career-advice/interviewing/starr-method" className="text-blue-600 hover:text-blue-800 underline">STARR framework</a>, and estimate the impact of what you did
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg mb-12">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
              <span className="text-gray-700 dark:text-gray-300">
                Consistency is key !! This includes formatting, <a href="https://www.themuse.com/advice/finally-the-answer-to-how-much-does-my-resume-font-matter" className="text-blue-600 hover:text-blue-800 underline">fonts</a> and no mistakes
              </span>
            </li>
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
            ...
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
              <span className="text-gray-700 dark:text-gray-300">
              Always <a href="/optimise-cv" className="text-blue-600 hover:text-blue 800 underline" >tailor a CV</a> to the job description and company culture, whilst avoiding sounding verbose and inauthentic. Be as clear and concise as possible.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
              <span className="text-gray-700 dark:text-gray-300">
                Avoid broad skills or <a href = "https://www.indeed.com/career-advice/resumes-cover-letters/buzzwords-to-avoid-in-resume" className="text-blue-600 hover:text-blue-800 underline">clichés</a>, but replace it with how it may have related to the task or action. e.g. “Teamworker” → “Collaborated on a project..”
              </span>
            </li>
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
              <span className="text-gray-700 dark:text-gray-300">
                Include <a href = "http://cheekyscientist.com/how-to-ensure-your-resume-makes-a-winning-first-impression/" className="text-blue-600 hover:text-blue-800 underline">appropriate sections</a>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <ClipboardCheck className="text-purple-500 flex-shrink-0" size={20} />
