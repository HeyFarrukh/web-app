        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/apprenticeships" className="text-gray-700 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 whitespace-nowrap">
                Apprenticeships
              </Link>
              <Link 
                href="/optimise-cv" 
              ...
              <Link href="/team" className="text-gray-700 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400">
                Team
              </Link>
