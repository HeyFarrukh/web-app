...
export const LogoScroll = () => {
  return (
    <div className="">
      <div className="animate-scroll flex w-max whitespace-nowrap">
        {allLogos.map((logo, index) => (
          ...
          >
            <img
              ...
              className="h-12 object-contain grayscale hover:grayscale-0 dark:invert transition-all duration-300 hover:scale-105"
            />
          </div>
        ))}
      </div>
