...
export const ListingMap: React.FC<ListingMapProps> = ({
  ...
  const [showNoLocationOverlay, setShowNoLocationOverlay] =
  ...
  const formattedAddress = addr
    ? [addr.addressLine1, addr.addressLine2, addr.addressLine3, addr.postcode]
        .filter(Boolean)
        .join(", ")
    : "";
  ...
  return (
    <div
      className="w-full rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 relative"
      style={{ height }}
    >
      <div
        ref={mapContainer}
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          <div className="text-center p-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-1">
              The exact location for this apprenticeship is not available.
            </p>
          </div>
        </div>
      )}
